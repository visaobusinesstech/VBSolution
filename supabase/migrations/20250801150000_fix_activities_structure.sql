-- Migração para corrigir a estrutura da tabela activities
-- Data: 2025-08-01
-- Problema: A tabela activities não tem a estrutura correta
-- Solução: Recriar a tabela com a estrutura correta
