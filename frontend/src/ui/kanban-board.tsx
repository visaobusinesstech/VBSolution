...
import { Calendar, GripVertical, MessageCircle, Paperclip, Plus, Clock, CheckCircle, AlertTriangle } from 'lucide-react';
          ...
          >
            ...
            <div className="space-y-4">
              {column.tasks.map((task) => (
                <Card
                  key={task.id}
                  className="cursor-move transition-all duration-300 border bg-white/60 dark:bg-neutral-800/60 backdrop-blur-sm hover:bg-white/70 dark:hover:bg-neutral-700/70 hover:shadow-lg min-h-[160px]"
                  draggable
